"""
Job data transformation module for normalizing and mapping fields.
"""
...
class JobTransformer:
    ...
    def map_education(val: str) -> str:
        """
        Normalizes education requirements.
    ...
    def extract_salary_range(val: str) -> tuple[int, int]:
        ...
        # Mapping for known salary ranges from API
        salary_mappings = {
        ...
        # If not in mapping, return (0, 0) for unknown
        return (0, 0)
    
    @staticmethod
    def map_experience(val: str) -> str:
        """
        Normalizes experience requirements.
    ...
    def map_work_policy(val: bool) -> str:
        """
        Normalizes work policy information.
    ...
    def transform_job(self, job: Dict[str, Any], headers: List[str]) -> List[str]:
        """
        Transforms a job dictionary into a row for Google Sheets.
